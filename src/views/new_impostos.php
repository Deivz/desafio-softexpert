		...
		<div class="col-md-8">
			<div class="card shadow-sm">
				<div class="card-header bg-primary text-white">
					<h5 class="card-title mb-0">Cadastrar Novo Imposto</h5>
				</div>
				<div class="card-body">
...
<script>
	...
	function clearForm() {
		document.getElementById('formTax').reset();
		...
		if (validateForm()) {
			...
			fetch('/impostos', {
				...
				.then(data => {
					...
					document.getElementById('successMessage').textContent = 'Imposto cadastrado com sucesso!';
					successModal.show();
				...
				.catch(error => {
					if (error.status === 409) {
						...
						const errorMessage = error.data.mensagem || 'Erro ao cadastrar imposto.';
